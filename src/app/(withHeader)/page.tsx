  ...
  return (
    <div>
      ...
      >
        ...
        <div className="mx-auto flex h-full w-full max-w-6xl flex-col gap-8 p-4 md:gap-0 md:p-6 lg:p-8">
          <div
            className={`flex h-full min-h-0 flex-col md:flex-row md:items-stretch md:gap-0 ${
              isMdUp
